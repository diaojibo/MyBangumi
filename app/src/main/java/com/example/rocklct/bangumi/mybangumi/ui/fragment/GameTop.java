 ...
 */
public class GameTop extends AbstractFragment implements HttpManager.OnConnectListener {
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getTopGame(load_pages);
            }
        });
    }

    public static GameTop getInstance() {
        GameTop fragment = new GameTop();
        return fragment;
    }
