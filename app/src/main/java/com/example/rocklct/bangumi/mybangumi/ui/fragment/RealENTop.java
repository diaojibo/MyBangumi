 ...
 */
public class RealENTop extends AbstractFragment implements HttpManager.OnConnectListener {
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getTopenReal(load_pages);
            }
        });
    }

    public static RealENTop getInstance() {
        RealENTop fragment = new RealENTop();
        return fragment;
    }
