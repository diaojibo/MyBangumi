...
//        toolbar.setNavigationIcon(R.drawable.testicon);
    ...
    private void initTabs() {
        ...
        mAdapter = new GetTabAdapter(getSupportFragmentManager()).getGameTabAdapter();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.book) {
            startActivity(new Intent(GameMainActivity.this, BookMainActivity.class));
            return false;
        }

        if (id == R.id.music) {
            startActivity(new Intent(GameMainActivity.this, MusicMainActivity.class));
            return false;
        }
        if (id == R.id.game) {
        ...
        if (id == R.id.real) {
            startActivity(new Intent(GameMainActivity.this, RealMainActivity.class));
            return false;
        }
        return false;
    }
