 ...
 */
public class SearchFragment extends AbstractFragment implements HttpManager.OnConnectListener {
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getSearchItems(searchName,load_pages);
            }
        });
    }
    ...
    @Override
    void initData() {
        mHttpManager.getSearchItems(searchName,1);
    }
