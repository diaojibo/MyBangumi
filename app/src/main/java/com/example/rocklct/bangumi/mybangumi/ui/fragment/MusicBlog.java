 ...
 */
public class MusicBlog extends AbstractFragment {
    ...
    public static MusicBlog newInstance(String id) {
        MusicBlog fragment = new MusicBlog();
...
//        mRecyclerView.addItemDecoration(new RecycleViewDivider(mContext, LinearLayoutManager.VERTICAL));
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getReviewFromType("music",load_pages);
            }
        });
    }
    ...
    @Override
    void initData() {
        mHttpManager.getReviewFromType("music",1);
    }
