 ...
 */
public class RealJPTop extends AbstractFragment implements HttpManager.OnConnectListener {
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getTopjpReal(load_pages);
            }
        });
    }

    public static RealJPTop getInstance() {
        RealJPTop fragment = new RealJPTop();
        return fragment;
    }
