...
//        toolbar.setNavigationIcon(R.drawable.testicon);
    ...
    private void initTabs() {
        ...
        mAdapter = new GetTabAdapter(getSupportFragmentManager()).getRealTabAdapter();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.book) {
            startActivity(new Intent(RealMainActivity.this, BookMainActivity.class));
            return false;
        }

        if (id == R.id.music) {
            startActivity(new Intent(RealMainActivity.this, MusicMainActivity.class));
            return false;
        }
        if (id == R.id.game) {
            startActivity(new Intent(RealMainActivity.this, GameMainActivity.class));
            return false;
        }
        if (id == R.id.real) {
            startActivity(new Intent(RealMainActivity.this, RealMainActivity.class));
            return false;
        }
