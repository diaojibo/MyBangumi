...
/**
 * 滑动返回Activity
 * Created by rocklct on 16-05-06.
 */
public abstract class AbstractSwipeActivity extends AppCompatActivity {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action){
            case MotionEvent.ACTION_DOWN:
                ...
                moveY = downY;
                lastX = downX;
                Log.i("activity-dispatch_DOWN", downX + "-" + downY);
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                dx = moveX - lastX;
                lastX = moveX;
                Log.i("activity-dispatch_MOVE",moveX+ "-"+moveY);
                break;
            case MotionEvent.ACTION_CANCEL:
                Log.i("activity-dispatch_CANCE","");
                break;
        }
        dispatch_flag = super.dispatchTouchEvent(ev);
        Log.i("activity_dispatch_flag", String.valueOf(dispatch_flag));
        Log.i("is_layout_dispatch_flag", String.valueOf(isLayoutDispatch));
    ...
    class SwipeLayout extends FrameLayout{
        ...
        public boolean dispatchTouchEvent(MotionEvent ev) {
            int action = ev.getAction();
            //dispatch_flag = super.dispatchTouchEvent(ev);
            Log.i("layout_dispatch_flag", String.valueOf(dispatch_flag));
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:
                    ...
                    Log.i("layout-onTouch_DOWN", layout_downX + "-" + layout_downY);
                    break;
                case MotionEvent.ACTION_MOVE:
                    ...
                    isLayoutDispatch = true;
                    Log.i("layout-onTouch_MOVE",layout_moveX+ "-"+layout_moveY+"dx="+dx);
                    break;
                case MotionEvent.ACTION_CANCEL:
                case MotionEvent.ACTION_UP:
                    ...
                    Log.i("layout-onTouch_CANCEL","");
                    break;
            }
            boolean flag = super.onTouchEvent(event);
            Log.i("layout_touch_flag", String.valueOf(flag));
            return flag;
        }
        //自动移动回原始位置 动画
        ...
        public boolean onInterceptTouchEvent(MotionEvent ev) {
            ...
            switch (action){
                case MotionEvent.ACTION_DOWN:
                    ...
                    layout_moveY = layout_downY;
                    layout_lastX = layout_downX;
                    Log.i("layout-Intercept_DOWN", layout_downX + "-" + layout_downY);
                    break;
                case MotionEvent.ACTION_MOVE:
                    ...
                    layout_lastX = layout_moveX;
                    Log.i("layout-Intercept_MOVE",layout_moveX+ "-"+layout_moveY);
                    break;
                case MotionEvent.ACTION_CANCEL:
                    Log.i("layout-Intercept_CANCE","");
                    break;
            }
            intercept_flag = super.onInterceptTouchEvent(ev);
            Log.i("layout_Intercept_flag",String.valueOf(intercept_flag));
