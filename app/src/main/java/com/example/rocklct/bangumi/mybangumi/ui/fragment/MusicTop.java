 ...
 */
public class MusicTop extends AbstractFragment implements HttpManager.OnConnectListener {
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getTopMusic(load_pages);
            }
        });
    }

    public static MusicTop getInstance() {
        MusicTop fragment = new MusicTop();
        return fragment;
    }
