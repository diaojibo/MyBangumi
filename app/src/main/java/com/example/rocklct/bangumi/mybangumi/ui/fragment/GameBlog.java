 ...
 */
public class GameBlog extends AbstractFragment {
    ...
    public static GameBlog newInstance(String id) {
        GameBlog fragment = new GameBlog();
...
//        mRecyclerView.addItemDecoration(new RecycleViewDivider(mContext, LinearLayoutManager.VERTICAL));
    ...
    private void initLoadView() {
        ...
        tv_more_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                load_pages++;
                isLoad = true;
                mHttpManager.getReviewFromType("game",load_pages);
            }
        });
    }
    ...
    @Override
    void initData() {
        mHttpManager.getReviewFromType("game",1);
    }
